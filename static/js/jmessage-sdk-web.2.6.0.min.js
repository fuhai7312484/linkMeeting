  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      (l.prototype.init = function(t) {
        ...
        (l.prototype.login = function(t) {
          ...
          var e = this,
            n = new a(this.channel)
              .setEvent(s.EVENTS.LOGIN)
              .setData(t)
              .addHook(function(n, o) {
                (e.current_user = t.username),
                  h.StorageUtils.removeItems(e.current_user),
        ...
        (l.prototype._initConversation = function() {
          ...
          null === e &&
            ((e = JSON.stringify({})),
            h.StorageUtils.addItem(t.channel.conversations_key, e)),
        ...
        (l.prototype.getUserInfo = function(t) {
          return (
            this.__checkLogin(),
            h.StringUtils.isBlack(t.appkey) && (t.appkey = this.current_appkey),
            new a(this.channel)
        ...
        (l.prototype.updateSelfInfo = function(t) {
          return (
            this.__checkLogin(),
            h.StringUtils.isBlack(t.avatar) || delete t.avatar,
            new a(this.channel)
        ...
        (l.prototype.sendChatroomMsg = function(t) {
          return (
            ...
            t.target_rname ||
              (t.target_rname =
                void 0 === h.Cache.rooms[t.target_rid]
                  ? ""
                  : h.Cache.rooms[t.target_rid].name),
            this.__sendMsg({
              type: "chatroom",
        ...
        (l.prototype._onSyncRoomMsg = function(t) {
          ...
          t.messages.forEach(function(n) {
            h.Cache.rooms[n.room_id] || e.getChatroomInfo({ id: t.room_id }),
              n.msgs &&
              ...
              (t.messages.forEach(function(t) {
                ...
                if (e.current_conversation === n)
                  (e.conversations[n] =
                    ...
                    (e.conversations[n].recent_time = r),
                  ...
                  (o = t.unsync_count),
                    ...
                    (e.conversations[n].msg_time = []);
                (e.lastMsgs[n] = { last_msg_time: r }),
                  delete t.unsync_count,
                  (t.unread_msg_count = e.conversations[n].unread_msg_count);
              }),
              h.StorageUtils.addItem(
                e.channel.conversations_key,
                JSON.stringify(e.conversations)
        ...
        (l.prototype._onSyncEvent = function(t) {
          ...
          (e.channel.sync_event_key = t.sync_key),
            h.StorageUtils.addItem(e.channel.event_key, t.sync_key);
          var n = { sync_key: e.channel.sync_event_key };
          new a(e.channel)
            .setEvent(s.EVENTS.SYNC_EVENT_ACK)
            .setData(n)
            .send(),
            setTimeout(function() {
              if (e._onSyncEventFn && t.events && t.events.length > 0) {
                ...
                t.events.forEach(function(o) {
                  if (200 === o.event_type)
                    ...
                    56 === t.event_type && 10 == t.extra
                      ? (delete r.extra, (r.by_self = !1))
                      : 56 === t.event_type &&
                        59 == t.extra &&
                        (delete r.extra, (r.by_self = !0)),
                      n.push(r);
                  }
                }),
                  e._onSyncEventFn(n);
        ...
        (l.prototype._onSyncMsgReceipt = function(t) {
          ...
          new a(e.channel)
            .setEvent(s.EVENTS.SYNC_RECEIPT_ACK)
            .setData(r)
            .send();
        }),
        ...
        (l.prototype._dealMutlReadEvent = function(t, e, n, o) {
          ...
          if (
            ((s.type = t),
            3 === t
              ? ((r = n + o), (s.username = o), (s.appkey = n))
              : ((r = String(n)), (s.gid = n)),
            (i.conversations[r] =
              void 0 === i.conversations[r]
                ? { msg_time: [], unread_msg_count: 0 }
                : i.conversations[r]),
            (i.conversations[r].recent_time = e),
            i.current_conversation === r)
          )
            (i.conversations[r].unread_msg_count = 0),
              (i.conversations[r].msg_time = []);
          else {
            ...
            i.conversations[r].msg_time.forEach(function(t) {
              ...
              (i.conversations[r].msg_time = c),
              u < a &&
                ((i.conversations[r].unread_msg_count = u),
                (s.unreadCount = u),
                h.StorageUtils.addItem(
                  i.channel.conversations_key,
                  JSON.stringify(i.conversations)
                ),
                i._conversationUpdateFun && i._conversationUpdateFun(s));
          }
        }),
          ...
          if (this.report.length > 0) {
            ...
            this.report.forEach(function(n) {
              if (t[n.args.key]) {
                ...
                Array.prototype.push.apply(e[o].result.msg_ids, n.args.msg_ids),
                  e[o].msg_reports.push(n);
              } else (t[n.args.key] = String(e.length)), e.push({ result: n.args, msg_reports: [n] });
            }),
              (this.report = []);
            for (var n = 0; n < e.length; n++)
              (e[n].result.msg_ids = h.ArrayUtils.delRepeatItem(
                e[n].result.msg_ids
              )),
                delete e[n].result.key,
                this._msgReceipt(e[n]);
          }
        }),
        ...
        (l.prototype.__uploadFile0 = function(t, e) {
          ...
          n.open("POST", this.opts.upload_file + "?type=" + t.type),
            n.setRequestHeader("X-App-Key", t.appkey),
            n.setRequestHeader("jm-channel", s.PLAT_CHANNEL),
            n.setRequestHeader(
              "Authorization",
              "Basic " + r.btoa(t.username + ":" + t.token)
            ),
              ...
              if (4 === this.readyState)
                if (200 === this.status) {
                  ...
                  try {
                    ...
                    898061 === n.error.code
                      ? e({ code: 880210, message: "file size exceed limit" })
                      : e(n);
                  } catch (t) {
        ...
        (l.prototype.__sendMsg = function(t) {
          ...
          return new a(this.channel)
            ...
            .setData(
              new u(this.current_user, this.current_appkey)
                .setType(t.type)
                .setAppkey(t.appkey)
        ...
        (l.prototype.__sendPic = function(t) {
          this.__checkLogin();
          var e = new a(this.channel).setEvent(
              "single" === t.type
                ? s.EVENTS.S_SINGLE_TEXT
                : "group" === t.type
                ? s.EVENTS.SEND_GROUP_MSG
            ...
            n = new u(this.current_user, this.current_appkey)
              .setType(t.type)
              .setAppkey(t.appkey)
              .setNeedReceipt(t.need_receipt)
              .setTarget(t.target_id, t.target_name)
            ...
            t.file
              ? this.__uploadFile(
                  ...
                  function(o, r) {
                    if (o)
                      return o.is_timeout
                        ? e.timeout && e.timeout(o.data)
                        : e.fail && e.fail(o.data);
                    e.setData(n.setImage(r, t.extras).build()).send();
                  }
                )
              : e
                  .setData(n.setImage(t.msg_body, t.msg_body.extras).build())
                  .send(),
            e
          );
        }),
        (l.prototype.__sendFile = function(t) {
          ...
          return (
            t.file
              ...
              : e
                  .setData(n.setFile(t.msg_body, t.msg_body.extras).build())
                  .send(),
            e
          );
        }),
      ...
      (function(n) {
        !(function(n, s) {
          ...
          "object" == typeof t && "object" == typeof t.exports
            ...
            : ((r = []),
              void 0 ===
                (i = "function" == typeof (o = s) ? o.apply(e, r) : o) ||
                (t.exports = i));
          ...
          function p(t, e) {
            ...
            return t instanceof p
              ...
              : r instanceof p
              ? ((r._chain = 0),
                (r._success = r._parallel = r._series = null),
                (r._finally = r._error = r._result = r._nextThen = null),
                arguments.length
                  ? ((n = d(r, e)),
                    void (void 0 ===
                    (t =
                ...
                function(n) {
                  n === e[0]
                    ? (function(t, e) {
                        ...
                        for (; !o && n._nextThen; )
                          (n = n._nextThen), (o = n._error || n._finally);
                        if (o)
                          return a(
                            function(t) {
          ...
          function d(t, e) {
            ...
            return (
              (n._isCont = !0),
              e && ((h.debug = "function" == typeof e ? e : E), (t._chain = 1)),
              n
            );
          }
          function _(t, e, n) {
          ...
          return (
            ...
            (h.toThunk = function() {
              ...
              return function(e) {
                t._result
                  ? (e.apply(null, t._result), (t._result = !1))
                  : !1 !== t._result && (t._finally = t._error = e);
              };
            }),
            (h.inspect = function() {
              var t = {};
              for (var e in this)
                o.call(this, e) &&
                  (t[e] =
                    "_nextThen" === e ? this[e] && this[e]._chain : this[e]);
              return t;
            }),
            (p.NAME = "Thenjs"),
            (p.VERSION = "2.0.3"),
    ...
    function(t, e) {
      ...
      function l() {
        p &&
          c &&
          ((p = !1), c.length ? (u = c.concat(u)) : (h = -1), u.length && f());
      }
      function f() {
        if (!p) {
          var t = a(l);
      ...
      !(function() {
        ...
        (o.prototype = new Error()),
          ...
          t.btoa ||
            (t.btoa = function(t) {
              for (
                var e, r, i = String(t), s = 0, a = n, c = "";
                i.charAt(0 | s) || ((a = "="), s % 1);
                c += a.charAt(63 & (e >> (8 - (s % 1) * 8)))
              ) {
                if ((r = i.charCodeAt((s += 0.75))) > 255)
                  throw new o(
          ...
          t.atob ||
            (t.atob = function(t) {
              ...
              for (
                var r, i, s = 0, a = 0, c = "";
                (i = e.charAt(a++));
                ~i && ((r = s % 4 ? 64 * r + i : i), s++ % 4)
                  ? (c += String.fromCharCode(255 & (r >> ((-2 * s) & 6))))
                  : 0
              )
                i = n.indexOf(i);
              return c;
    ...
    function(t, e, n) {
      ...
      (s.prototype.init = function(t) {
        (this.opts = t),
          ...
          (this.sync_key = 0),
          (this.sync_type = 0),
          (this.client = r(this.opts.address, {
        ...
        (s.prototype.onReceive = function(t, e) {
          if (
            (this.opts.debug &&
            //   console.info("---<- event:%s, data:%s", t, JSON.stringify(e)),
            t !== i.EVENTS.EVENT_NOTIFICATION &&
              t !== i.EVENTS.MSG_SYNC &&
              t !== i.EVENTS.SYNC_CONVERSATION &&
              t !== i.EVENTS.SYNC_EVENT &&
              t !== i.EVENTS.SYNC_RECEIPT &&
              t !== i.EVENTS.RECEIPT_CHANGE &&
              t !== i.ROOM_MSG_SYNC &&
              t !== i.ROOM_MSG_SYNC_HIS)
          ) {
            var n = this.dataCache[e.rid];
            delete e.rid,
              n &&
                (0 === e.code && t === i.EVENTS.GET_GROUP_MEMBERS
                  ? e.member_list.forEach(function(t) {
                      n.userInfoGet && n.userInfoGet(t.uid, t.mtime),
                        delete t.uid,
                        delete t.mtime;
                    })
                  : 0 === e.code && t === i.EVENTS.GET_FRIEND_LIST
                  ? e.friend_list.forEach(function(t) {
                      n.userInfoGet && n.userInfoGet(t.uid, 1e3 * t.mtime),
                        delete t.uid;
                    })
                  : 0 === e.code && t === i.EVENTS.GET_BLACK_LIST
                  ? e.black_list.forEach(function(t) {
                      delete t.uid;
                    })
                  : 0 === e.code &&
                    t === i.EVENTS.GET_ACROSS_USER_INFO &&
                    delete e.user_info.uid,
                t === i.EVENTS.ACK
                  ...
                  : (n.cleanRespTimeout(),
                    ...
                    e.code && 0 !== e.code
                      ? n.fail && n.fail(e)
                      : t != i.EVENTS.S_SINGLE_TEXT_ &&
                        t != i.EVENTS.SEND_GROUP_MSG &&
                        t != i.EVENTS.SEND_ROOM_MSG
                      ? n.hook
                        ? n.hook(e, n.success)
                        : n.success && n.success(e)
                      : ((n.data.msg_id = e.msg_id),
                        t === i.EVENTS.S_SINGLE_TEXT_ &&
                          ((e.target_username = n.data.target_id),
        ...
        (s.prototype.send = function(t, e) {
          this.opts.debug &&
            // console.info("---\x3e- event:%s, data:%s", t, JSON.stringify(e)),
    ...
    function(t, e, n) {
      ((e = t.exports = i.debug = i).coerce = function(t) {
        ...
        (e.enable = function(t) {
          e.save(t);
          for (
            var n = (t || "").split(/[\s,]+/), o = n.length, r = 0;
            r < o;
            r++
          )
            n[r] &&
      ...
      function i(t) {
        ...
        function i() {
          ...
          (t.diff = s),
            ...
            null == t.color &&
              t.useColors &&
              (t.color = e.colors[r++ % e.colors.length]);
      ...
      function u(t) {
        ...
        return (
          ...
          (e.BINARY_EVENT != t.type && e.BINARY_ACK != t.type) ||
            ((n += t.attachments), (n += "-")),
          t.nsp && "/" != t.nsp && ((i = !0), (n += t.nsp)),
          null != t.id && (i && ((n += ","), (i = !1)), (n += t.id)),
          null != t.data && (i && (n += ","), (n += r.stringify(t.data))),
          o("encoded %j as %s", t, n),
          n
        );
      }
      function p() {
                  ...
                  if (u) {
                    ...
                    try {
                      u =
                        ...
                        "[null]" == c([_]) &&
                        "null" == c(null) &&
                        "[null,null,null]" == c([_, g, null]) &&
                        c({ a: [s, !0, !1, null, "\0\b\n\f\r\t"] }) == a &&
                        "1" === c(null, s) &&
                        "[\n 1,\n 2\n]" == c([1, 2], null, 1) &&
                        '"-271821-04-20T00:00:00.000Z"' == c(new i(-864e13)) &&
                        '"+275760-09-13T00:00:00.000Z"' == c(new i(864e13)) &&
                        '"-000001-01-01T00:00:00.000Z"' ==
                          c(new i(-621987552e5)) &&
                        '"1969-12-31T23:59:59.999Z"' == c(new i(-1));
                    } catch (t) {
                      u = !1;
                    }
                  }
            ...
            if (!v("json")) {
                  ...
                  D = function(t, e, n, o, r, i, s) {
                    ...
                    if ("object" == typeof a && a)
                      if (
                        ...
                        if (R) {
                          for (
                            l = N(a / 864e5), p = N(l / 365.2425) + 1970 - 1;
                            R(p + 1, 0) <= l;
                            p++
                          );
                          for (
                ...
                e.stringify = function(t, e, n) {
                  ...
                  if (s[typeof e] && e)
                    if ((a = g.call(e)) == E) r = e;
                      ...
                      i = {};
                      for (
                        var c, u = 0, p = e.length;
                        u < p;
                        c = e[u++],
                          ((a = g.call(c)) == S || a == k) && (i[c] = 1)
                      );
                    }
                  if (n)
                    if ((a = g.call(n)) == k) {
              ...
              if (!v("json-parse")) {
                var I,
                  ...
                  U = function() {
                    for (var t, e, n, o, r, i = x, s = i.length; I < s; )
                      switch ((r = i.charCodeAt(I))) {
                        ...
                        default:
                          if (
                            ((e = I),
                            45 == r && ((o = !0), (r = i.charCodeAt(++I))),
                            r >= 48 && r <= 57)
                          ) {
                            for (
                              48 == r &&
                                ((r = i.charCodeAt(I + 1)) >= 48 && r <= 57) &&
                                P(),
                                o = !1;
                              I < s && ((r = i.charCodeAt(I)) >= 48 && r <= 57);
                              I++
                            );
                  ...
                  V = function(t, e, n) {
                    ...
                    if ("object" == typeof r && r)
                      if (g.call(r) == T) for (o = r.length; o--; ) B(r, o, n);
                      else
                        d(r, function(t) {
                          B(r, t, n);
                        });
              ...
              d = p(
                ...
                (c.JSON3 = {
                  noConflict: function() {
                    return (
                      f ||
                        ((f = !0), (c.JSON = h), (c.JSON3 = l), (h = l = null)),
                      d
                    );
                  }
                })
        ...
        (e.deconstructPacket = function(t) {
          ...
          return (
            (i.data = (function t(n) {
              ...
              if (o(n)) {
                for (var s = new Array(n.length), a = 0; a < n.length; a++)
                  s[a] = t(n[a]);
                return s;
              }
        ...
        function h(t, n) {
          ...
          (n = n || {}),
            ...
            t
              ...
              : n.host && (n.hostname = c(n.host).host),
            (this.secure =
              null != n.secure
                ? n.secure
            ...
            (this.rejectUnauthorized =
              void 0 === n.rejectUnauthorized ? null : n.rejectUnauthorized),
                  ...
                  if (!n)
                    if ("pong" === r.type && "probe" === r.data) {
                      ...
                      (h.priorWebsocketSuccess = "websocket" === e.name),
                        i('pausing current transport "%s"', o.transport.name),
        ...
        (t.exports = u),
          ...
          (p.prototype.create = function() {
            ...
            try {
              ...
              if (
                (this.supportsBinary && (n.responseType = "arraybuffer"),
                "POST" === this.method)
              )
                try {
                  this.isBinary
    ...
    function(t, e, n) {
      (function(t) {
        ...
        (e.encodePacket = function(n, o, r, i) {
          "function" == typeof o && ((i = o), (o = !1)),
            "function" == typeof r && ((i = r), (r = null));
          var s,
            a,
            u,
            p = void 0 === n.data ? void 0 : n.data.buffer || n.data;
          if (t.ArrayBuffer && p instanceof ArrayBuffer)
          ...
          if (p && p.base64)
            return (
              (s = n),
              (a = i),
              (u = "b" + e.packets[s.type] + s.data.data),
              a(u)
            );
          var f = l[n.type];
          return (
            void 0 !== n.data &&
              (f += r ? c.encode(String(n.data)) : String(n.data)),
            i("" + f)
          );
        }),
          (e.encodeBase64Packet = function(n, o) {
            ...
            try {
              ...
              for (
                var a = new Uint8Array(n.data), c = new Array(a.length), u = 0;
                u < a.length;
                u++
              )
                c[u] = a[u];
          ...
          (e.decodePacket = function(t, n, o) {
            ...
            if ("string" == typeof t) {
              ...
              if (
                ...
                return d;
              var r = t.charAt(0);
              return Number(r) == r && f[r]
                ? t.length > 1
                  ? { type: f[r], data: t.substring(1) }
                  : { type: f[r] }
                : d;
            }
            ...
            var i = s(t, 1);
            return (
              _ && "blob" === n && (i = new _([i])), { type: f[r], data: i }
            );
          }),
          ...
          (e.encodePayload = function(t, n, o) {
            ...
            if (n && r)
              return _ && !h
                ? e.encodePayloadAsBlob(t, o)
                : e.encodePayloadAsArrayBuffer(t, o);
          ...
          (e.decodePayload = function(t, n, o) {
            ...
            var r;
            if (("function" == typeof n && ((o = n), (n = null)), "" == t))
              return o(d, 0, 1);
            for (var i, s, a = "", c = 0, u = t.length; c < u; c++) {
              ...
              if (":" != p) a += p;
                ...
                if (s.length) {
                  if (
                    ((r = e.decodePacket(s, n, !0)),
                    d.type == r.type && d.data == r.data)
                  )
                    return o(d, 0, 1);
              ...
              function(t, e) {
                ...
                return (
                  e.forEach(function(t) {
                    ...
                    r[i++] = 255;
                    for (o = new Uint8Array(n), s = 0; s < o.length; s++)
                      r[i++] = o[s];
                  }),
                  n(r.buffer)
                );
          ...
          (e.decodePayloadAsBinary = function(t, n, o) {
            ...
            for (var r = t, i = [], a = !1; r.byteLength > 0; ) {
              for (
                var c = new Uint8Array(r), u = 0 === c[0], p = "", h = 1;
                255 != c[h];
                h++
              ) {
                if (p.length > 310) {
    ...
    function(t, e) {
      t.exports = function(t, e, n) {
        ...
        for (
          var r = new Uint8Array(t), i = new Uint8Array(n - e), s = e, a = 0;
          s < n;
          s++, a++
        )
          i[a] = r[s];
    ...
    function(t, e) {
      ...
      t.exports = function(t, e, o) {
        ...
        function i(t, n) {
          ...
          --i.count,
            t ? ((r = !0), e(t), (e = o)) : 0 !== i.count || r || e(null, n);
        }
      };
    },
    function(t, e, n) {
        ...
        !(function(i) {
          ...
          function l(t) {
            for (var e, n, o = [], r = 0, i = t.length; r < i; )
              (e = t.charCodeAt(r++)) >= 55296 && e <= 56319 && r < i
          ...
          var g = {
            version: "1.0.0",
            encode: function(t) {
              for (var e = l(t), n = e.length, o = -1, r = ""; ++o < n; )
                r += d(e[o]);
              return r;
            },
            decode: function(t) {
      ...
      (function(e) {
        ...
        h || "undefined" != typeof window || (h = o),
                ...
                i.encodePacket(t, n.supportsBinary, function(r) {
                  if (!n.usingBrowserWebSocket) {
                    ...
                    if (
                      ...
                      ("string" == typeof r
                        ? e.Buffer.byteLength(r)
                        : r.length) < n.perMessageDeflate.threshold &&
                        (i.compress = !1);
                  }
                  try {
          ...
          (l.prototype.check = function() {
            return !(
              !h ||
              ("__initialize" in h && this.name === l.prototype.name)
            );
          });
      }.call(e, window));
    },
      ...
      t.exports = function() {
                ...
                (f = i(
                  (f = i(
                        ...
                        (f = r(
                          (f = r(
                            ...
                            (d = r(
                              ...
                              (_ = r(
                                _,
                                (l = r(l, f, d, _, e[a + 1], 4, -1530992060)),
                                f,
                                d,
                                e[a + 4],
                                11,
                          ...
                          (d = r(
                            ...
                            (_ = r(
                              _,
                              (l = r(l, f, d, _, e[a + 13], 4, 681279174)),
                              f,
                              d,
                              e[a],
                              11,
                    ...
                    (d = i(
                      ...
                      (_ = i(
                        _,
                        (l = i(l, f, d, _, e[a + 12], 6, 1700485571)),
                        f,
                        d,
                        e[a + 3],
                        10,
                  ...
                  (d = i(
                    ...
                    (_ = i(
                      _,
                      (l = i(l, f, d, _, e[a + 8], 6, 1873313359)),
                      f,
                      d,
                      e[a + 15],
                      10,
        ...
        function l(t, e) {
          return (function(t, e) {
            ...
            for (
              i[15] = u[15] = void 0,
                r.length > 16 && (r = s(r, 8 * t.length)),
                n = 0;
              n < 16;
              n += 1
            )
              (i[n] = 909522486 ^ r[n]), (u[n] = 1549556828 ^ r[n]);
            return (
              (o = s(i.concat(c(e)), 512 + 8 * e.length)),
              a(s(u.concat(o), 640))
            );
          })(p(t), p(e));
        }
        ...
        o = {
          ...
          removeItems: function(t) {
            if (window.localStorage) {
              for (var e = localStorage.length, n = [], o = 0; o < e; o++)
                localStorage.getItem(localStorage.key(o)) === t &&
                  n.push(localStorage.key(o));

...
<div v-if="!show2">
  <group class="myfan-fanlistBox">
      <cell v-for="(fan,index) in myfanData" :key="index" :title="fan.name" is-link :link="{path:'/myfan/myfanDetail/'+fan.id,query: {fansId:fan.id}}" >
        <img slot="icon" width="45" style="display:block;margin-right:.8rem;border-radius:50%;" :src="fan.mainPic==null?require('../../assets/images/myFans-Mask.png'):fan.mainPic">
      </cell>
    </group>
    ...
    data() {
      return {
        ...
        myfanData:[
          // {
          //   name:'彭秀英',
          //   mainPic:'https://pic.qqtn.com/up/2017-12/15129631876172056.gif',
          //   id:'',
          // },
          // {
          //   name:'蒋强',

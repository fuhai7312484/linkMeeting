<template>
  <div class="hello">
    ...
    <ul>
      ...
      <router-link tag="li" to="/codelogin">验证码登录</router-link>
              ...
              <router-link tag="li" to="/downApp">APP下载</router-link>
                <router-link tag="li" to="/lot">抽奖</router-link>
                 ...
                 <router-link tag="li" to="/awardlist/123">微信抽奖</router-link>
                  <router-link tag="li" to="/initlist/123">发起抽奖</router-link>
      ...
      <router-link tag="li" to="/signinfo">报名信息</router-link>
      <div>--------------消息-----------------------</div>
      ...
      <router-link tag="li" to="/myfollow">我的关注</router-link>
      <router-link tag="li" to="/myfan">我的粉丝</router-link>
      <router-link tag="li" to="/MyTicket">会议票券</router-link>
         <router-link tag="li" to="/mybrowse">浏览记录</router-link>
      <router-link tag="li" to="/feedback">用户反馈</router-link>
      <router-link tag="li" to="/setting">设置</router-link>

      <!-- <div @click="submitData">用户登录</div>
      <div @click="submitData1">获取个人信息</div> -->
...
export default {
  ...
  methods: {
    ...
    submitData1() {
      ...
      // checkToken(getDataInfo("get", "user/userById", userObj))
      // .then(res=>{
      //   console.log(res)
      //   // alert(res)
      //   // this.myData2 = res.data.data
